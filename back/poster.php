<div class="rb tab" style="width:98%">
  ...
  <div style="width:100%;height:200px;overflow-y:scroll;color:#fff;">
    <?php
  $posters=$Poster->all();
  foreach($posters as $poster){
    ?>
    <div class="ct" style="width:100%;display:flex;align-items:center;background:white;margin:1px 0;">
